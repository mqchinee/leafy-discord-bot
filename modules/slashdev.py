...
class SlashCommands(commands.Cog, name ="Слэш-команды"):
	...
	@nextcord.slash_command(description='Вывести аватарку пользователя', guild_ids=testingServerID)
	...
	@nextcord.slash_command(description='Магический шар!', guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Сменить префикс бота на сервере", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Привет!", guild_ids=testingServerID)
	async def hello(self, interaction:Interaction):
		author = interaction.user
		await interaction.response.send_message(f'Привет, {author.mention}')

	@nextcord.slash_command(description="Информация о текущем сервере", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description='Информация о пользователе', guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Создать вложение", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Never Gonna Give You Up!", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Рандомный мем с Reddit!", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Рандомная лисичка с Reddit!", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Поиск видео с YouTube", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Пригласить меня на сервер!", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Установить медленный режим в канале", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Украсть эмоджи с другого сервера", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Создать опрос", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Проверить совместимость двух пользователей", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Подбросить монетку (орёл/решка)", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Бросить кости", guild_ids=testingServerID)
	...
	@nextcord.slash_command(description="Информация о настройках сервера", guild_ids=testingServerID)
